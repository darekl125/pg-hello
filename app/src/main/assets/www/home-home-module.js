...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.login = function () {
        this.googleplus.login({
            ...
            firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithCredential(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider.credential(res.idToken))
                .then(function (suc) {
                alert("LOGIN SUC");
            }).catch(function (ns) {
                alert("NOT SUCCESS");
